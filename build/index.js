...
function EditContainer(props) {
  ...
  const onChangeQuoteFontColor = newColor => {
    setAttributes({
      quoteFontColor: newColor
    });
  };
  const onChangeCitationFontColor = newColor => {
    setAttributes({
      citationFontColor: newColor
    });
  };
  ...
  const colorSettingsDropDown = [{
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Quote font color', 'wp-quote-blocks')
  }, {
    value: attributes.citationFontColor,
    onChange: onChangeCitationFontColor,
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Citation font color', 'wp-quote-blocks')
  }];
  ...
  }, fontFamilySelector)), fontWeights.length !== 0 && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.__experimentalToolsPanelItem, {
